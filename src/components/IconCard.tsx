...
export function IconCard({ icon, isCopied, onCopyJpg, onOpenDetail }: IconCardProps) {
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-slate-100 bg-white p-3 shadow-soft transition-all duration-200 hover:-translate-y-1 hover:shadow-hover sm:p-4">
      ...
      <div className="mt-4 grid grid-cols-1 gap-2 opacity-100 transition-opacity duration-200 min-[420px]:grid-cols-2 md:opacity-0 md:group-hover:opacity-100">
        {icon.filePaths.jpg ? (
          <button
            type="button"
